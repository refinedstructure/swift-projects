...
Based on the research documented in [[https://github.com/refinedstructure/swift-projects/blob/main/cli-apps/HabitTracker/research/discovery.md]], three core problem patterns consistently emerge across habit-tracking products.

First, most habit-tracking apps over-index on **daily consistency and streak preservation**. Progress is framed in an all-or-nothing manner, where missing a single day resets or devalues prior effort. This rigidity creates unnecessary pressure and often leads to anxiety, guilt, and disengagement. Instead of supporting habit formation, streak-centric systems can punish normal human variability, which is counterproductive to long-term behavior change.
